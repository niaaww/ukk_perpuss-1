                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method= "post">
                                            ...
                                            <br>
                                            <div class="form-group">
                                            <label class="small mb-1">No_Telp</label>
                                                <input class="form-control" type="text" required name="no_telp" placeholder="Masukan No_Telp" />
                                            </div>
                                            <br>
                                            <div class="form-group">
                                            ...
                                            <label class="small mb-1">Password</label>
                                                <input class="form-control"  type="text" required  name="password" placeholder="Masukan Password" />
                                            </div>
                                            <br>
