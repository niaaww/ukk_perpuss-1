        ...
        <div class="row">
            <div class="col-md-12">
                <form method="post">
                    ...
                    $query = mysqli_query($koneksi, "INSERT INTO buku(id_kategori, judul_buku, penulis, penerbit, thn_terbit, deskripsi)
                     values ('$id_kategori','$judul_buku','$penulis','$penerbit','$thn_terbit','$deskripsi')");
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8"><input type="text" class="form-control"name="thn_terbit"></div>
                    </div>
